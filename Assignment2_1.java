...
public class Assignment2_1 {
    ...
    public void sortSalary(Employee e1, Employee e2, Employee e3) {
        ...
        if (employees[1].salary > e3.salary) {
            employees[2] = employees[1];
            employees[1] = e3;
            if (employees[0].salary > e3.salary) {
    ...
    /*
     ...
     Reason and explain:
     Because in the Java, the object memory is stored by the reference by the memory address, to once the reference is
     changed, the object instance is changed. It is not a actual value changed.
    */
